...
class ChatGPT:
    def __init__(self, model="gpt-3.5-turbo"):
        assert model in {"text-davinci-003", "gpt-3.5-turbo-16k", "gpt-3.5-turbo", "gpt-4o", "gpt-4-turbo", "gpt-4-vision-preview"}, f"Unknown model: {model}"
        self.model = model
    ...
    async def send_message(self, message, dialog_messages=[], chat_mode="assistant"):
        ...
        while answer is None:
            try:
                if self.model in {"gpt-3.5-turbo-16k", "gpt-3.5-turbo", "gpt-4o", "gpt-4-turbo", "gpt-4-vision-preview"}:
    ...
    async def send_message_stream(self, message, dialog_messages=[], chat_mode="assistant"):
        ...
        while answer is None:
            try:
                if self.model in {"gpt-3.5-turbo-16k", "gpt-3.5-turbo", "gpt-4o", "gpt-4-turbo"}:
                    messages = self._generate_prompt_messages(message, dialog_messages, chat_mode)
